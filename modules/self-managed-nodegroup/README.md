...
| <a name="module_vpc"></a> [vpc](#module\_vpc) | terraform-aws-modules/vpc | ~> 3.0 |
...
|------|-------------|------|:---------:|
| <a name="ami"></a> [ami](#ami) | Amazon Machine Image name | `string` | `amazon_linux` |
| <a name="eks_version"></a> [eks_version](#eks_version) | EKS Version | `string` | `1.22` |
...
| <a name="region"></a> [region](#region) | Region | `string` | `ap-southeast-1` |
 <a name="name"></a> [name](#name) | Name of cluster | `string` | `inception-eks-karpenter` |
