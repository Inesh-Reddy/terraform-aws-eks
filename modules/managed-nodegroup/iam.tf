module "iam-all-ec2-describe-policy" {
  source = "git::https://github.com/Inesh-Reddy/terraform-aws-iam.git//examples/iam-all-ec2-describe-policy"
...
module "iam_iam-eks-describe-cluster" {
  source = "git::https://github.com/Inesh-Reddy/terraform-aws-iam.git//examples/iam-eks-describe-cluster-policy"
...
module "iam_iam-assumable-role" {
  ...
  source = "git::https://github.com/Inesh-Reddy/terraform-aws-iam.git//examples/iam-assumable-role"
